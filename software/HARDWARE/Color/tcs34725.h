...
#define TCS_SDA_IN()  {GPIOB->CRL&=0xFF0FFFFF;GPIOB->CRL|=8<<20;}
#define TCS_SDA_OUT() {GPIOB->CRL&=0xFF0FFFFF;GPIOB->CRL|=3<<20;}
#define TCS_SDA_READ   GPIOB->IDR&(1<<5)

#define TCS_SCL_H     GPIO_SetBits(GPIOB,GPIO_Pin_4)
#define TCS_SCL_L     GPIO_ResetBits(GPIOB,GPIO_Pin_4)
#define TCS_SDA_H     GPIO_SetBits(GPIOB,GPIO_Pin_5)
#define TCS_SDA_L     GPIO_ResetBits(GPIOB,GPIO_Pin_5)
/******************************************************************************/
